...
(function(O, W, t) {
    ...
    return function() {
      ...
      for (a = 1; a < arguments.length; a++) {
        ...
        e = "function" == typeof e
          ...
          : "undefined" == typeof e
            ? "undefined"
            : "string" != typeof e ? JSON.stringify(e) : e;
        c += d(e);
      }
      return Error(c);
    };
  ...
  function Da(b) {
    ...
    return b.nodeType === pa && a
      ? !0
      : I(b) || G(b) || 0 === a || "number" === typeof a && 0 < a && a - 1 in b;
  }
  function m(b, a, c) {
    var d, e;
    if (b)
      ...
      else if (lc(b)) for (d in b) a.call(c, b[d], d, b);
    ...
    for (var d = b.$$hashKey, e = 0, f = a.length; e < f; ++e) {
      ...
      if (D(g) || C(g))
        for (var h = Object.keys(g), l = 0, k = h.length; l < k; l++) {
          ...
          c && D(q)
            ? ca(q)
              ? b[n] = new Date(q.valueOf())
              : Oa(q)
                ? b[n] = new RegExp(q)
                : (D(b[n]) || (b[n] = G(q) ? [] : {}), Mb(b[n], [q], !0))
            : b[n] = q;
        }
    }
    oc(b, d);
  ...
  function fa(b, a, c, d) {
    ...
    if (a) {
      ...
      if (G(b))
        ...
        var f = a.$$hashKey;
        G(a) ? a.length = 0 : m(a, function(b, c) {
            delete a[c];
          });
        if (lc(b)) for (e in b) a[e] = fa(b[e], null, c, d);
  ...
  function ka(b, a) {
    ...
    if (c == typeof a && "object" == c) if (G(b)) {
        ...
        if ($a(b) || $a(a) || Ya(b) || Ya(a) || G(a) || ca(a) || Oa(a))
          return !1;
        c = ga();
  ...
  function xc(b) {
    ...
    m((b || "").split("&"), function(b) {
      var d, e, f;
      b &&
        (e = b = b.replace(/\+/g, "%20"), d = b.indexOf("="), -1 !== d &&
          (e = b.substring(0, d), f = b.substring(d + 1)), e = wc(e), x(e) &&
          (f = x(f) ? wc(f) : !0, Na.call(a, e)
            ? G(a[e]) ? a[e].push(f) : a[e] = [a[e], f]
            : a[e] = f));
    });
    return a;
  }
  ...
  function yc(b, a, c) {
    ...
    O &&
      e.test(O.name) &&
      (c.shrinkEnabled = !0, O.name = O.name.replace(e, ""));
  ...
  function ub(b, a) {
    ...
    d &&
      (a
        ? delete d.data[a]
        : (d.handle &&
          (d.events.$destroy && d.handle({}, "$destroy"), Nc(
            b
          )), delete gb[c], b.ng339 = t));
  }
  function vb(b, a) {
    var c = b.ng339, c = c && gb[c];
    a &&
      !c &&
      (b.ng339 = c = ++Ef, c = gb[c] = {events: {}, data: {}, handle: t});
    return c;
  }
  function Vb(b, a, c) {
    if (Kc(b)) {
  ...
  function Ga(b, a) {
    ...
    c = typeof b;
    return c = "function" == c || "object" == c && null !== b
      ? b.$$hashKey = c + ":" + (a || Ud)()
      : c + ":" + b;
  }
  function Ua(b, a) {
  ...
  function If(b) {
    return (b = b.toString().replace(Tc, "").match(Uc))
    ...
    function g(a) {
      ...
      m(a, function(a) {
        ...
        if (!n.get(a)) {
          ...
          try {
            I(a)
              ? (c = Rb(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(
                c._invokeQueue
              ), d(c._configBlocks))
              : C(a)
                ? b.push(r.invoke(a))
                : G(a) ? b.push(r.invoke(a)) : Sa(a, "module");
          } catch (e) {
            throw (G(a) &&
              (a = a[a.length -
                1]), e.message && e.stack && -1 == e.stack.indexOf(e.message) && (e = e.message + "\n" + e.stack), Ha("modulerr", a, e.stack || e.message || e));
          }
        }
      });
      return b;
        ...
        function f(b) {
          if (b) {
            ...
            C(c)
              ? c = c()
              : rc(c)
                ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position
                  ? 0
  ...
  function Cc(b, a) {
    ...
    this.directive = function r(a, f) {
      Ta(a, "directive");
      I(a)
        ? (d(a), pb(f, "directiveFactory"), e.hasOwnProperty(a) ||
          (e[a] = [], b.factory(a + "Directive", [
            "$injector",
            "$exceptionHandler",
            function(b, d) {
              var f = [];
                ...
                try {
                  ...
                  D(l.scope) &&
                    (!0 === l.bindToController
                      ? (n.bindToController = c(
                        l.scope,
                        r,
                        !0
                      ), n.isolateScope = {})
                      : n.isolateScope = c(l.scope, r, !1));
                  D(l.bindToController) &&
                    (n.bindToController = c(l.bindToController, r, !0));
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function(a, b, c, d, w, p, A, s, H, N, J) {
        function F(a, b) {
          try {
            a.addClass(b);
          } catch (c) {
        ...
        function S(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            var f, l, k, r, n, u, N;
            if (p)
              for (N = Array(c.length), r = 0; r < h.length; r += 3)
                f = h[r], N[f] = c[f];
            else
              N = c;
            r = 0;
            for (n = h.length; r < n; )
              if ((l = N[h[r++]], c = h[r++], f = h[r++], c)) {
                if (c.scope) {
                  if (
                    (k = a.$new(), V.$$addScopeInfo(
                      z(l),
                      k
                    ), u = c.$$destroyBindings)
                  )
                    c.$$destroyBindings = null, k.$on("$destroyed", u);
                } else k = a;
                u = c.transcludeOnThisElement
                  ? P(a, c.transclude, e)
          ...
          for (var h = [], l, k, r, n, p, u = 0; u < a.length; u++) {
            ...
            (f = k.length ? E(k, a[u], l, b, c, null, [], [], f) : null) &&
              f.scope &&
            ...
            l = f && f.terminal || !(r = a[u].childNodes) || !r.length
              ...
              : S(
                r,
                f
                  ? (f.transcludeOnThisElement || !f.templateOnThisElement) &&
                    f.transclude
                  : b
              );
        ...
        function ha(a, b, c, d, e) {
          ...
          switch (a.nodeType) {
            case pa:
              x(b, va(ta(a)), "E", d, e);
              for (
                var k, r, n, p = a.attributes, u = 0, N = p && p.length;
                u < N;
                u++
              ) {
                var K = !1, J = !1;
                ...
                L(S) &&
                  k === S + "Start" &&
                  (K = l, J = l.substr(0, l.length - 5) + "end", l = l.substr(
                    0,
                    l.length - 6
                  ));
                k = va(l.toLowerCase());
              ...
              if (I(a) && "" !== a)
                for (; l = g.exec(a); )
                  k = va(l[2]), x(b, k, "C", d, e) &&
                    (c[k] = T(l[3])), a = a.substr(l.index + l[0].length);
              break;
            case Pa:
              if (11 === Va)
                for (
                  ...
                  a.nodeValue += a.nextSibling.nodeValue, a.parentNode.removeChild(
                    a.nextSibling
                  );
              wa(b, a.nodeValue);
              break;
            case 8:
              try {
                if (l = f.exec(a.nodeValue))
                  k = va(l[1]), x(b, k, "M", d, e) && (c[k] = T(l[2]));
              } catch (B) {
              }
          }
          b.sort(za);
        ...
        function E(a, b, d, e, f, g, h, k, r) {
          ...
          function N(a, b, c, d, e, f) {
            ...
            for (h in d) {
              ...
              g[l.name] = k;
              s || a.data("$" + l.name + "Controller", k.instance);
            }
            return g;
          }
          function K(a, c, e, f, g, l) {
            ...
            P &&
              (V.$$addScopeInfo(
                ...
                B,
                !0,
                !(F && (F === P || F === P.$$originalDirective))
              ), V.$$addScopeClass(
                ja,
                !0
              ), B.$$isolateBindings = P.$$isolateBindings, Y(
                c,
                f,
                B,
                B.$$isolateBindings,
            ...
            if (A) {
              ...
              m &&
                A[m.name] &&
                (p = m.$$bindings.bindToController, (J = A[m.name]) &&
                  J.identifier &&
                  p &&
                  (H = J, l.$$destroyBindings = Y(c, f, J.instance, p, m)));
              for (n in A) {
                J = A[n];
                var E = J();
                E !== J.instance &&
                  (J.instance = E, ja.data("$" + n + "Controller", E), J ===
                    H &&
                    (l.$$destroyBindings(), l.$$destroyBindings = Y(
                      c,
                      f,
                      E,
                      p,
            ...
            for (l = h.length; n < l; n++)
              p = h[n], $(
                ...
                ja,
                f,
                p.require && u(p.directiveName, p.require, ja, A),
                ha
              );
            var ya = c;
          ...
          for (
            var J = -Number.MAX_VALUE,
              ...
              w = r.controllerDirectives,
              P = r.newIsolateScopeDirective,
              F = r.templateDirective,
              A = r.nonTlbTranscludeDirective,
              m = !1,
              H = !1,
              s = r.hasElementTranscludeDirective,
              ba = d.$$element = z(b),
              E,
              x,
              v,
            ...
            if (v = E.scope)
              E.templateUrl ||
                (D(v)
                  ? (O("new/isolated scope", P || S, E, ba), P = E)
                  : O("new/isolated scope", P, E, ba)), S = S || E;
            x = E.name;
            !E.templateUrl &&
              E.controller &&
              (v = E.controller, w = w || ga(), O(
                "'" + x + "' controller",
                w[x],
                E,
                ba
            ...
            if (v = E.transclude)
              m = !0, E.$$tlb ||
                (O("transclusion", A, E, ba), A = E), "element" == v
                ? (s = !0, J = E.priority, v = ba, ba = d.$$element = z(
                  W.createComment(" " + x + ": " + d[x] + " ")
                ), b = ba[0], U(f, xa.call(v, 0), b), y = V(
                  v,
                  e,
                  J,
                  g && g.name,
            ...
            if (E.template)
              if (
                (H = !0, O("template", F, E, ba), F = E, v = C(E.template)
                  ? E.template(ba, d)
                  : E.template, v = fa(v), E.replace)
              ) {
                g = E;
                ...
                ba.html(v);
            if (E.templateUrl)
              H = !0, O("template", F, E, ba), F = E, E.replace &&
                (g = E), K = Lf(
                a.splice(wa, a.length - wa),
                ba,
                d,
                f,
                m && y,
                ...
                za = E.compile(
                  ...
                  d,
                  y
                ), C(za) ? n(null, za, Bb, M) : za && n(za.pre, za.post, Bb, M);
              } catch (R) {
                c(R, ua(ba));
              }
        ...
        function x(b, d, f, g, h, l, k) {
          ...
          if (e.hasOwnProperty(d)) {
            var n;
            d = a.get(d + "Directive");
            for (var p = 0, u = d.length; p < u; p++) try {
                n = d[p], (g === t || g > n.priority) && -1 != n.restrict.indexOf(f) && (l && (n = Nb(n, {$$start: l, $$end: k})), b.push(n), h = n);
              } catch (J) {
                c(J);
              }
          }
        ...
        function $c(a, b) {
          ...
          m(b, function(b, f) {
            "class" == f
              ? (F(e, b), a["class"] = (a["class"] ? a["class"] + " " : "") + b)
              : "style" == f
                ? (e.attr(
                  "style",
                  e.attr("style") + ";" + b
        ...
        function Lf(a, b, c, e, f, g, h, l) {
          ...
          return function(a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (k
                ? k.push(b, c, d, a)
                : (r.transcludeOnThisElement && (a = P(b, r.transclude, e)), r(
                  n,
                  b,
                  c,
                  d,
          ...
          m(e, function(e, g) {
            ...
            switch (e.mode) {
              ...
              case "=":
                ...
                k.$stateful = !0;
                k = e.collection
                  ? a.$watchCollection(c[l], k)
                  : a.$watch(w(c[l], k), null, n.literal);
                h = h || [];
                h.push(k);
                break;
              case "&":
          ...
          $set: function(a, b, d, e) {
            ...
            if ("a" === g && "href" === a || "img" === g && "src" === a)
              ...
              for (
                ...
                k < l;
                k++
              ) var r = 2 * k, g = g + J(T(h[r]), !0), g = g + (" " + T(h[r + 1]));
              h = T(h[2 * k]).split(/\s/);
              g += J(T(h[0]), !0);
              2 === h.length && (g += " " + T(h[1]));
              this[a] = b = g;
        ...
        V.$$addScopeInfo = n ? (function(a, b, c, d) {
            a.data(
              c ? d ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope",
              b
            );
          }) : v;
        ...
        return function(f, g, h, l) {
          ...
          if (I(f)) {
            ...
            f = b.hasOwnProperty(n)
              ? b[n]
              : Bc(g.$scope, n, !0) || (a ? Bc(d, n, !0) : t);
            Sa(f, n, !0);
          }
          if (h)
            return h = (G(f)
              ? f[f.length - 1]
              : f).prototype, k = Object.create(h || null), q &&
              e(g, q, k, n || f.name), Q(
              function() {
                var a = c.invoke(f, k, g, n);
                a !== k &&
                  (D(a) || C(a)) &&
                  (k = a, q && e(g, q, k, n || f.name));
                return k;
              },
      ...
      function(e, f, g, h, l, k) {
        function n(a) {
          function d(a) {
            var b = Q({}, a);
            b.data = a.data
              ? ed(a.data, a.headers, a.status, f.transformResponse)
              : a.data;
            a = a.status;
          ...
          f.paramSerializer = I(f.paramSerializer)
            ? k.get(f.paramSerializer)
            : f.paramSerializer;
          var g = [
            function(a) {
        ...
        function q(c, d) {
          function g(b, c, d, e) {
            ...
            F &&
              (200 <= b && 300 > b ? F.put(P, [b, c, cd(d), e]) : F.remove(P));
          ...
          !c.cache && !b.cache ||
            ...
            (F = D(c.cache) ? c.cache : D(b.cache) ? b.cache : u);
          F &&
            (m = F.get(P), x(m)
              ? m && C(m.then)
                ? m.then(q, q)
                : G(m) ? k(m[1], m[0], ia(m[2]), m[3]) : k(m, 200, {}, "OK")
              : F.put(P, J));
          y(m) &&
            ((m = gd(c.url) ? f()[c.xsrfCookieName || b.xsrfCookieName] : t) &&
              (S[c.xsrfHeaderName || b.xsrfHeaderName] = m), e(
              c.method,
              P,
              d,
              g,
        ...
        var u = g("$http");
        b.paramSerializer = I(b.paramSerializer)
  ...
  function Sf(b, a, c, d, e) {
    function f(a, b, c) {
      ...
      n = function(a) {
        ...
        a &&
          ("load" !== a.type ||
            d[b].called ||
            (a = {type: "error"}), u = a.type, g = "error" === a.type
            ? 404
            : 200);
        c && c(g, u);
      };
    ...
    return function(e, h, l, k, n, q, r, u) {
      ...
      if ("jsonp" == M(e)) {
        ...
        var p = f(
          h.replace("JSON_CALLBACK", "angular.callbacks." + w),
          w,
          function(a, b) {
            K(k, a, d[w].data, "", b);
            d[w] = v;
    ...
    this.$get = [
      ...
      function(c, d, e) {
        ...
        function h(f, h, n, q) {
          ...
          q = !!q;
          for (
            var p, m, s = 0, H = [], N = [], J = f.length, F = [], V = [];
            s < J;
            
          )
            if (-1 != (p = f.indexOf(b, s)) && -1 != (m = f.indexOf(a, p + l)))
              s !== p && F.push(g(f.substring(s, p))), s = f.substring(
                p + l,
                m
              ), H.push(s), N.push(c(s, w)), s = m + k, V.push(
                F.length
              ), F.push("");
            else {
      ...
      function(b, a, c, d) {
        function e(e, h, l, k) {
          ...
          p.$$intervalId = r(
            function() {
              ...
              0 < l &&
                B >= l &&
                (w.resolve(B), u(p.$$intervalId), delete f[p.$$intervalId]);
              K || b.$apply();
            },
            h
          );
        ...
        e.cancel = function(b) {
          return b && b.$$intervalId in f
            ? (f[b.$$intervalId].reject("canceled"), a.clearInterval(
              b.$$intervalId
  ...
  function bc(b, a, c) {
    ...
    this.$$compose = function() {
      var b = Pb(this.$$search), c = this.$$hash ? "#" + nb(this.$$hash) : "";
    ...
    this.$$parseLinkUrl = function(d, e) {
      ...
      var f, g;
      (f = ra(b, d)) !== t
        ? (g = f, g = (f = ra(c, f)) !== t ? a + (ra("/", f) || f) : b + g)
        : (f = ra(a, d)) !== t ? g = a + f : a == d + "/" && (g = a);
      g && this.$$parse(g);
      return !!g;
    };
  }
  function cc(b, a, c) {
    ...
    this.$$parse = function(d) {
      ...
      y(e) || "#" !== e.charAt(0)
        ? this.$$html5 ? f = e : (f = "", y(e) && (b = d, this.replace()))
        : (f = ra(c, e), y(f) && (f = e));
      id(f, this);
      d = this.$$path;
      var e = b, g = /^\/[A-Z]:(\/.*)/;
  ...
  function gf() {
    ...
    this.html5Mode = function(b) {
      return ab(b)
        ? (a.enabled = b, this)
        : D(b)
          ? (ab(b.enabled) && (a.enabled = b.enabled), ab(b.requireBase) &&
            (a.requireBase = b.requireBase), ab(b.rewriteLinks) &&
        ...
        f.on("click", function(b) {
          if (
            ...
            B.test(h) ||
              ...
              !k.$$parseLinkUrl(h, l) ||
              (b.preventDefault(), k.absUrl() != d.url() &&
        ...
        c.$watch(function() {
          ...
          if (K || n) K = !1, c.$evalAsync(function() {
              ...
              k.absUrl() === b &&
                (d
                  ? (k.$$parse(a), k.$$state = f)
                  : (n && h(b, g, f === k.$$state ? null : k.$$state), l(
                    a,
                    f
                  )));
            });
    ...
    this.$get = [
      ...
      function(c) {
        function d(a) {
          a instanceof Error &&
            (a.stack
              ? a = a.message && -1 === a.stack.indexOf(a.message)
                ? "Error: " + a.message + "\n" + a.stack
                : a.stack
              : a.sourceURL &&
                (a = a.message + "\n" + a.sourceURL + ":" + a.line));
  ...
  function U(b, a) {
    ...
    switch (b.type) {
      ...
      case s.ConditionalExpression:
        ...
        U(b.alternate, a);
        U(b.consequent, a);
        b.constant = b.test.constant &&
          b.alternate.constant &&
          b.consequent.constant;
        b.toWatch = b.constant ? [] : [b];
        break;
      case s.Identifier:
        b.constant = !1;
    ...
    this.$get = [
      ...
      function(c) {
        ...
        function e(a, b, c, e, f) {
          ...
          for (var k = [], n = [], q = 0, m = g.length; q < m; q++)
            k[q] = d, n[q] = null;
          return a.$watch(
            function(a) {
        ...
        function l(a, b) {
          ...
          a.$$watchDelegate && a.$$watchDelegate !== e
            ...
            : b.$stateful ||
              (c.$$watchDelegate = e, c.inputs = a.inputs ? a.inputs : [a]);
          return c;
        }
        var k = Fa().noUnsafeEval,
          n = {csp: k, expensiveChecks: !1},
          q = {csp: k, expensiveChecks: !0};
          ...
          switch (typeof d) {
            case "string":
              ...
              m ||
                (":" === d.charAt(0) &&
                  ":" === d.charAt(1) &&
                  (w = !0, d = d.substring(2)), B = B ? q : n, m = new ec(
                  B
                ), m = new fc(m, c, B).parse(d), m.constant
                  ? m.$$watchDelegate = h
                  : w
                    ? m.$$watchDelegate = m.literal ? g : f
                    : m.inputs && (m.$$watchDelegate = e), s[p] = m);
              return l(m, k);
            case "function":
              return l(d, k);
            default:
    ...
    Q(g.prototype, {
      ...
      $$resolve: function(b) {
        ...
        try {
          ...
          C(d)
            ? (this.promise.$$state.status = -1, d.call(
              b,
              e[0],
              e[1],
              this.notify
            ))
            : (this.promise.$$state.value = b, this.promise.$$state.status = 1, f(
              this.promise.$$state
            ));
        } catch (g) {
          e[1](g), a(g);
      ...
      function(f, g, h, l) {
        ...
        n.prototype = {
          ...
          $watch: function(a, b, c, e) {
            ...
            var g = this,
              l = g.$$watchers,
              k = {fn: b, last: s, get: f, exp: e || a, eq: !!c};
            d = null;
            C(b) || (k.fn = v);
            l || (l = g.$$watchers = []);
            l.unshift(k);
          ...
          $watchCollection: function(a, b) {
              ...
              if (!y(e)) {
                if (D(e))
                  if (Da(e))
                    for (
                      f !== q &&
                        (f = q, u = f.length = 0, k++), a = e.length, u !== a &&
                        (k++, f.length = u = a), b = 0;
                      b < a;
                      b++
                    )
                      h = f[b], g = e[b], d = h !== h && g !== g, d ||
                        h === g ||
                        (k++, f[b] = g);
                  else {
                    f !== r && (f = r = {}, u = 0, k++);
            ...
            return this.$watch(n, function() {
              ...
              if (l) if (D(e)) if (Da(e)) {
                  ...
                  } else for (a in (g = {}, e)) Na.call(e, a) && (g[a] = e[a]);
                else g = e;
            });
          },
          $digest: function() {
            ...
            do {
              ...
              do {
                if (k = m.$$watchers) for (n = k.length; n--; ) try {
                      if (b = k[n])
                        if (
                          ...
                          r = !0, d = b, b.last = b.eq ? fa(f, null) : f, b.fn(
                            f,
                            h === s ? f : h,
                            m
                          ), 5 > u &&
                            (E = 4 - u, w[E] || (w[E] = []), w[E].push({
                              msg: C(b.exp)
                ...
                if (
                  !(k = m.$$watchersCount && m.$$childHead ||
                    m !== this && m.$$nextSibling)
                )
          ...
          $broadcast: function(a, b) {
            ...
            for (var f = cb([e], arguments, 1), h, l; c = d; ) {
              ...
              if (
                !(d = c.$$listenerCount[a] && c.$$childHead ||
        ...
        return {
          ...
          getTrusted: function(c, e) {
            ...
            if (c === oa.RESOURCE_URL) {
              ...
              q = 0;
              for (r = b.length; q < r; q++) if (d(b[q], g)) {
                  u = !0;
                  break;
                }
      ...
      function(b, a, c, d, e) {
        ...
        f.cancel = function(b) {
          return b && b.$$timeoutId in g
            ? (g[b.$$timeoutId].reject(
              "canceled"
            ), delete g[b.$$timeoutId], a.defer.cancel(b.$$timeoutId))
            : !1;
        };
        return f;
      }
    ...
    return function() {
      ...
      if (b !== e)
        for (e = b, b = e.split("; "), d = {}, h = 0; h < b.length; h++)
          g = b[h], l = g.indexOf("="), 0 < l &&
            (k = a(g.substring(0, l)), d[k] === t &&
              (d[k] = a(g.substring(l + 1))));
      return d;
    };
  }
  function yf() {
  ...
  function Cd(b, a, c, d, e) {
    ...
    if (g || k) 0 < e && 1 > b && (l = b.toFixed(e), b = parseFloat(l));
      ...
      var g = ("" + b).split(Dd),
        ...
        u = a.gSize;
      if (h.length >= r + u)
        for (q = h.length - r, k = 0; k < q; k++)
          0 === (q - k) % u && 0 !== k && (l += c), l += h.charAt(k);
      for (
        k = q;
        k < h.length;
        k++
  ...
  function bg() {
    return function(b, a, c) {
      ...
      return 0 <= a
        ? b.slice(c, c + a)
        : 0 === c ? b.slice(a, b.length) : b.slice(Math.max(0, c + a), c);
    };
  }
  function Bd(b) {
    function a(a, c) {
    ...
    return function(b, e, f) {
      ...
      b.sort(function(a, b) {
        for (var c = 0, d = 0, e = g.length; d < e; ++d) {
          ...
          c.type === f.type
            ? c.value !== f.value && (u = c.value < f.value ? -1 : 1)
            : u = c.type < f.type ? -1 : 1;
  ...
  function jb(b, a, c, d) {
    return function(e, f, g, h, l, k, n) {
      ...
      h.$parsers.push(function(b) {
        return h.$isEmpty(b)
          ? null
          : a.test(b) ? (b = c(b, m), u && (b = Ob(b, u)), b) : t;
      });
  ...
  function Id(b, a, c, d) {
    (d.$$hasNativeValidators = D(a[0].validity)) &&
  ...
  function Hd(b) {
    ...
    d.$setValidity = function(b, e, f) {
      e === t
        ...
        : (d.$pending && h(d.$pending, b, f), Ld(d.$pending) &&
          (d.$pending = t));
      ab(e)
        ? e
      ...
      d.$pending
        ...
        : (a(Md, !1), d.$valid = Ld(d.$error), d.$invalid = !d.$valid, c(
          "",
          d.$valid
        ));
      e = d.$pending && d.$pending[b]
        ? t
        : d.$error[b] ? !1 : d.$$success[b] ? !0 : null;
      c(b, e);
      l.$setValidity(b, e, d);
    };
  }
  ...
  var G = Array.isArray,
    ...
    ob = function() {
      ...
      for (a = 0; a < c; ++a)
        if (
          (d = Qa[a], b = W.querySelector("[" + d.replace(":", "\\:") + "jq]"))
        ) {
  ...
  var Ra = R.prototype = {
    ready: function(b) {
      ...
      "complete" === W.readyState
        ? setTimeout(a)
        : (this.on("DOMContentLoaded", a), R(O).on("load", a));
    },
    toString: function() {
      var b = [];
      m(this, function(a) {
  ...
  m(
    {
      ...
      inheritedData: zb,
      scope: function(b) {
        return z.data(b, "$scope") ||
          zb(b.parentNode || b, ["$isolateScope", "$scope"]);
      },
      isolateScope: function(b) {
        return z.data(b, "$isolateScope") ||
          z.data(b, "$isolateScopeNoTemplate");
      },
      controller: Oc,
      injector: function(b) {
  ...
  m(
    {
      ...
      triggerHandler: function(a, c, d) {
        ...
        if (h = (h = h && h.events) && h[g]) e = {
            ...
            type: g,
            target: a
          }, c.type && (e = Q(e, c)), c = ia(h), f = d ? [e].concat(d) : [e], m(c, function(c) {
  ...
  eb.$$annotate = function(a, c, d) {
    ...
    if ("function" === typeof a) {
      if (!(e = a.$inject)) {
        ...
        ? (c = a.length - 1, Sa(a[c], "fn"), e = a.slice(0, c))
        : Sa(a, "fn", !0);
    return e;
  };
  var Nd = L("$animate"),
          ...
          return function(c, f) {
            function g() {
              a(function() {
                ...
                f.removeClass &&
                  (c.removeClass(f.removeClass), f.removeClass = null);
  ...
  var Xc = /^((?:x|data)[\:\-_])/i,
    ...
    bd = "application/json",
    $b = {"Content-Type": bd + ";charset=utf-8"},
    Pf = /^\[|^\{(?!\{)/,
    Qf = {"[": /]$/, "{": /}$/},
    Of = /^\)\]\}',?\n/,
    og = L("$http"),
      ...
      search: function(a, c) {
        switch (arguments.length) {
          case 0:
            return this.$$search;
          case 1:
            if (I(a) || X(a)) a = a.toString(), this.$$search = xc(a);
  ...
  ec.prototype = {
    ...
    readString: function(a) {
      ...
      for (var d = "", e = a, f = !1; this.index < this.text.length; ) {
        ...
        if (f)
          "u" === g
            ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(
              /[\da-f]{4}/i
            ) ||
              this.throwError(
                "Invalid unicode escape [\\u" + f + "]"
              ), this.index += 4, d += String.fromCharCode(parseInt(f, 16)))
            : d += rg[g] || g, f = !1;
        else if ("\\" === g) f = !0;
        else {
          if (g === a) {
  ...
  s.prototype = {
    ...
    constants: {
      ...
      undefined: {type: s.Literal, value: t},
  ...
  rd.prototype = {
    compile: function(a, c) {
      ...
      this.stage = "assign";
      if (g = pd(e))
        this.state.computing = "assign", f = this.nextId(), this.recurse(
          g,
          f
      ...
      if (!g && x(a.watchId))
        ...
        switch (a.type) {
            ...
            k.recurse(
              ...
              function() {
                k.if_(
                  ...
                  function() {
                    if (a.computed)
                      l = k.nextId(), k.recurse(
                        a.property,
                        l
                      ), k.addEnsureSafeMemberName(l), f &&
                        1 !== f &&
                        k.if_(
                          k.not(k.computedMember(h, l)),
                          k.lazyAssign(k.computedMember(h, l), "{}")
                        ), q = k.ensureSafeObject(
                        k.computedMember(h, l)
                      ), k.assign(c, q), d && (d.computed = !0, d.name = l);
                    else {
                      Wa(a.property.name);
                      f &&
                        1 !== f &&
          ...
          case s.CallExpression:
            c = c || this.nextId();
            a.filter
              ? (l = k.filter(a.callee.name), n = [], m(a.arguments, function(
                a
              ) {
                var c = k.nextId();
                k.recurse(a, c);
                n.push(c);
              }), q = l + "(" + n.join(",") + ")", k.assign(c, q), e(c))
              : (l = k.nextId(), h = {}, n = [], k.recurse(
                a.callee,
                l,
                h,
                function() {
                    ...
                    function() {
                      ...
                      h.name
                        ? (k.state.expensiveChecks ||
                          k.addEnsureSafeObject(h.context), q = k.member(
                          h.context,
                          h.name,
                          h.computed
                        ) +
  ...
  sd.prototype = {
    ...
    recurse: function(a, c, d) {
      ...
      switch (a.type) {
        ...
        case s.BinaryExpression:
          return e = this.recurse(
            a.left
          ), f = this.recurse(a.right), this["binary" + a.operator](e, f, c);
        case s.LogicalExpression:
          return e = this.recurse(
            a.left
          ), f = this.recurse(a.right), this["binary" + a.operator](e, f, c);
        ...
        case s.MemberExpression:
          return e = this.recurse(
            ...
            !1,
            !!d
          ), a.computed || (Wa(a.property.name, g.expression), f = a.property.name), a.computed && (f = this.recurse(a.property)), a.computed ? this.computedMember(e, f, c, d, g.expression) : this.nonComputedMember(e, f, g.expensiveChecks, c, d, g.expression);
        case s.CallExpression:
          return h = [], m(a.arguments, function(a) {
            ...
            (f = this.$filter(
              a.callee.name
            )), a.filter || (f = this.recurse(a.callee, !0)), a.filter ? (function(a, d, e, g) {
              for (
                var r = [], m = 0;
                m < h.length;
                ++m
              ...
              if (null != r.value) {
                ...
                for (
                  ...
                  s < h.length;
                  ++s
                ) m.push(Ba(h[s](a, d, e, q), g.expression));
        ...
        case s.AssignmentExpression:
          return e = this.recurse(
            ...
            !0,
            1
          ), f = this.recurse(a.right), function(a, d, h, q) {
            var m = e(a, d, h, q);
            a = f(a, d, h, q);
            ...
            return {
              pre: function(a, d, f, g) {
                ...
                h && (B(a, g), f.$observe(h, function(c) {
                    g.$name !== c &&
                      (B(a, t), s.$$renameControl(g, c), B = e(g.$name), B(
                        a,
                        g
                      ));
                  }));
          ...
          if (I(a)) {
            ...
            if (d) {
              var e = +d[1],
                ...
                f = 7 * (f - 1);
              c &&
                (d = c.getHours(), g = c.getMinutes(), h = c.getSeconds(), l = c.getMilliseconds());
  ...
  var xe = [
        ...
        link: function(c, d, e, f, g) {
          ...
          c.$watch(e.ngIf, function(c) {
            c ? l || g(function(c, f) {
                ...
                (k.remove(), k = null), l && (l.$destroy(), l = null), h && (k = qb(h.clone), a.leave(k).then(function() {
                  k = null;
                }), h = null));
          });
        }
        ...
        return {
          ...
          link: function(c, d, e, f) {
            /SVG/.test(d[0].toString())
              ? (d.empty(), a(Lc(f.template, W).childNodes)(
                c,
                function(a) {
                  d.append(a);
                },
    ...
    xg = [
      ...
      function(a, c, d, e, f, g, h, l, k, n) {
        ...
        var q = f(d.ngModel), r = q.assign, s = q, B = r, K = null, w, p = this;
        ...
        this.$validate = function() {
          if (!X(p.$modelValue) || !isNaN(p.$modelValue)) {
            ...
            p.$$runValidators(a, p.$$lastCommittedViewValue, function(f) {
              e ||
                c === f ||
                (p.$modelValue = f ? a : t, p.$modelValue !== d &&
                  p.$$writeModelToScope());
            });
          }
        };
        ...
        this.$commitViewValue = function() {
          ...
          if (
            ...
            p.$$lastCommittedViewValue = a, p.$pristine &&
        ...
        this.$$parseAndValidate = function() {
          ...
          p.$$rawModelValue = c;
          f &&
            (p.$modelValue = c, p.$modelValue !== e && p.$$writeModelToScope());
          p.$$runValidators(c, p.$$lastCommittedViewValue, function(a) {
            f ||
              (p.$modelValue = a ? c : t, p.$modelValue !== e &&
                p.$$writeModelToScope());
          });
        };
        ...
        this.$$debounceViewValueCommit = function(c) {
          ...
          e &&
            ...
            (e = e.debounce, X(e)
              ? d = e
              : X(e[c]) ? d = e[c] : X(e["default"]) && (d = e["default"]));
          h.cancel(K);
          d ? K = h(
              function() {
                p.$commitViewValue();
              ...
              d
            ) : l.$$phase ? p.$commitViewValue() : a.$apply(function() {
                p.$commitViewValue();
              });
        };
        a.$watch(function() {
          var c = s(a);
          if (
            c !== p.$modelValue && (p.$modelValue === p.$modelValue || c === c)
          ) {
            ...
            for (var d = p.$formatters, e = d.length, f = c; e--; )
              f = d[e](f);
            p.$viewValue !== f &&
              (p.$viewValue = p.$$lastCommittedViewValue = f, p.$render(), p.$$runValidators(
                c,
                f,
                v
              ));
        ...
        controller: [
          ...
          function(a, c) {
            ...
            this.$options.updateOn !== t
              ? (this.$options.updateOnDefault = !1, this.$options.updateOn = T(
        ...
        return {
          ...
          link: function(c, h, l, k) {
                ...
                a.group
                  ? (g = c[a.group], g ||
                    (g = q(
                      ...
                      "optgroup",
                      f
                    ), d = g.nextSibling, g.label = a.group, g = c[a.group] = {
                      groupElement: g,
                    ...
                    "option",
                    e
                  ), n(a, k), g.currentOptionElement = k.nextSibling)
            ...
            if (v) {
              ...
              k = l.multiple;
              for (
                var p, x = 0, y = h.children(), C = y.length;
                x < C;
                x++
              ) if ("" === y[x].value) {
                  p = y.eq(x);
              ...
              k ? (v.$isEmpty = function(a) {
                  ...
                  var a = h.val() || [], c = [];
                  m(a, function(a) {
                    (a = F.selectValueMap[a]) &&
                      !a.disabled &&
                      c.push(F.getViewValueFromOption(a));
                  });
                  return c;
                  ...
                  c && !c.disabled
                    ? h[0].value !== c.selectValue &&
                      (J.remove(), N ||
                        p.remove(), h[0].value = c.selectValue, c.element.selected = !0, c.element.setAttribute(
                        "selected",
                        "selected"
                      ))
                    : null === a || N
                      ? (J.remove(), N || h.prepend(p), h.val(""), p.prop(
                        "selected",
                        !0
                      ), p.attr("selected", !0))
                      : (N || p.remove(), h.prepend(J), h.val("?"), J.prop(
                        "selected",
                        !0
                      ), J.attr("selected", !0));
                }, w.readValue = function() {
                  ...
                  return a && !a.disabled
                    ? (N || p.remove(), J.remove(), F.getViewValueFromOption(a))
                    : null;
            ...
            g.$watch(n, function(c) {
              ...
              e === z ||
                ...
                (A(), f = t[e], y(f)
                  ? (null != c &&
                    d.debug(
                      "ngPluralize: no rule defined for '" + e + "' in " + q
                    ), A = v, k())
                  : A = g.$watch(f, k), z = e);
            });
          }
            ...
            return function(a, f, g, k, n) {
              ...
              a.$watchCollection(q, function(g) {
                ...
                if (Da(g)) L = g, q = p || A;
                    ...
                    y, L = [], g)) g.hasOwnProperty(M) && "$" !== M.charAt(0) && L.push(M);
                D = L.length;
                M = Array(D);
                for (
                  k = 0;
        ...
        return {
          ...
          link: function(c, d, e) {
            c.$watch(e.ngShow, function(c) {
              a[c
                ? "removeClass"
                : "addClass"](d, "ng-hide", {tempClasses: "ng-hide-animate"});
            });
          }
        };
      }
        ...
        return {
          ...
          link: function(c, d, e) {
            c.$watch(e.ngHide, function(c) {
              a[c
                ? "addClass"
                : "removeClass"](d, "ng-hide", {tempClasses: "ng-hide-animate"});
            });
          }
        };
      }
    ...
    Cg = [
      ...
      function(a, c, d) {
        ...
        e.writeValue = function(c) {
          e.hasOption(c)
            ? (e.removeUnknownOption(), a.val(c), "" === c &&
              e.emptyOption.prop("selected", !0))
          ...
          compile: function(d, e) {
            ...
            return function(a, d, e) {
              ...
              m && m.ngModelCtrl && (f ? a.$watch(f, function(a, f) {
                    ...
                    e.value,
                    d
                  ), m.ngModelCtrl.$render(), c(d)), d.on("$destroy", function() {
